...
Legordulo::Legordulo(int x, int y, int kissizex, int kissizey, int nagysize, std::vector<std::string> opciok):
           Kivalaszto_os(x, y, kissizex, kissizey, nagysize, opciok)
{
}
