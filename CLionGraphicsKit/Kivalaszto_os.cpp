...
Kivalaszto_os::Kivalaszto_os(Os_alkalmazas* szulo, int x, int y, int kissizex, int kissizey, bool kell, int nagysize, std::vector<std::string> opciok):
               Widget(szulo, x, y, kissizex, kissizey, kell), nagysize(nagysize), opciok(opciok)
{
}
