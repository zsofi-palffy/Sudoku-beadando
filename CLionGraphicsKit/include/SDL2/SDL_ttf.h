...
/* Create an 8-bit palettized surface and render the given text at
   fast quality with the given font and color.  The 0 Color is the
   colorkey, giving a transparent background, and the 1 Color is set
   to the text color.
...
/* Create an 8-bit palettized surface and render the given text at
   high quality with the given font and colors.  The 0 Color is background,
