 ...
 *
 *  This variable can be set to the following values:
 *    "0" or "nearest" - Nearest Color sampling
 *    "1" or "linear"  - Linear filtering (supported by OpenGL and Direct3D)
 *    "2" or "best"    - Currently this is the same as "linear"
 *
 *  By default nearest Color sampling is used
 */
...
*  created SDL_Window:
*
*  1. Its Color format will be set to the same Color format as this SDL_Window.  This is
