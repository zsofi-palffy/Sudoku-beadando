    ...
    void fajl_valaszto() { //megadja, hogy melyik fájlt kell beolvasni
        if (menu) {
            ...
            if (feladat == "1. szint") {
                ...
                megjelenitettek = {{0, 0}, {0, 1}, {0, 4}, {0, 6},
                                      {1, 2}, {1, 3}, {1, 5}, {1, 7},
                                      {2, 1}, {2, 2}, {2, 5}, {2, 7},
                                      {3, 0}, {3, 2}, {3, 4}, {3, 8},
                                      {4, 1}, {4, 3}, {4, 5}, {4, 8},
                ...
                megjelenitettek = {{0, 0}, {0, 3}, {0, 6}, {0, 7},
                                      {1, 1}, {1, 4}, {1, 5}, {1, 8},
                                      {2, 2}, {2, 4}, {2, 6}, {2, 7},
                                      {3, 0}, {3, 1}, {3, 3}, {3, 5}, {3, 7},
                                      {4, 1}, {4, 2}, {4, 4}, {4, 6}, {4, 8},
                ...
                megjelenitettek = {{0, 2}, {0, 4}, {0, 5}, {0, 7},
                                      {1, 1}, {1, 3}, {1, 5}, {1, 6}, {1, 8},
                                      {2, 0}, {2, 2}, {2, 4}, {2, 6},
                                      {3, 2}, {3, 4}, {3, 5}, {3, 7},
                                      {4, 0}, {4, 2}, {4, 4}, {4, 8},
...
protected:
    bool menu, jatekter, vege; //állapotok
    ...
    std::ifstream befajl;
    bool hibas = false, van_hiba = false;
};
